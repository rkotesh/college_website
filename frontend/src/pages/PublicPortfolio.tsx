...
${profile.profileSummary}` : `I'm **${name}**, a student at CIET currently building my portfolio. Ask me about my projects or skills!`, chips: ['What are your skills? 🧠','Show your projects 🚀','Education details 🎓'], scroll: 'about' };
  ...
  if (error || !data) return (
    <div style={{ minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', background:'#0e1117' }}>
      <div style={{ maxWidth:'480px', padding:'48px', textAlign:'center', background:'#161920', border:'1px solid #282f3e', borderRadius:'16px' }}>
        <div style={{ fontSize:'48px', marginBottom:'16px' }}>🔒</div>
        <h2 style={{ fontFamily:"'Outfit',sans-serif", fontSize:'22px', fontWeight:800, color:'#eef0f6', marginBottom:'8px' }}>Portfolio Unavailable</h2>
        <p style={{ color:'#99a0b5', fontSize:'14px' }}>{error || 'No data.'}</p>
      </div>
    </div>
  );
    ...
    <div className="_pp">
      ...
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        /* ── nav ── */
        ._nav{position:fixed;top:0;left:0;right:0;z-index:100;background:rgba(14,17,23,.82);backdrop-filter:blur(20px);border-bottom:1px solid #282f3e}
        ...
        ._btn:hover{transform:translateY(-2px)}
        ...
        ._tb p{font-size:13px;color:#99a0b5;margin-bottom:10px}
        ._tb ul{padding-left:16px;margin-bottom:12px}
        ._tb li{font-size:12.5px;color:#99a0b5;margin-bottom:5px}
        ._ttags{display:flex;gap:6px;flex-wrap:wrap}
        ._ttag{font-size:11px;padding:3px 8px;border-radius:100px;background:rgba(255,255,255,.04);border:1px solid #282f3e}
        ...
        ._ciw{width:100%;aspect-ratio:1.414/1;overflow:hidden;background:#1c202a;border-bottom:1px solid #282f3e;position:relative}
        ._ciw img{width:100%;height:100%;object-fit:cover;transition:transform .6s}
        ._cc:hover ._ciw img{transform:scale(1.04)}
        ._cov{position:absolute;inset:0;background:rgba(14,17,23,.87);display:flex;align-items:center;justify-content:center;opacity:0;transition:opacity .3s;z-index:10}
        ._cc:hover ._cov{opacity:1}
        ._ci{padding:22px;flex:1;display:flex;flex-direction:column}
        ._ci h3{font-size:14px;font-weight:700;margin-bottom:6px}
        ._ci p{font-size:12px;color:#99a0b5;line-height:1.5;margin-bottom:14px;flex:1}

        /* ── marquee ── */
        ._mw{overflow:hidden;padding:22px 0;border-top:1px solid #282f3e;border-bottom:1px solid #282f3e}
        ...
        ._csc .sn{font-weight:700;font-size:13px}
        ._csc .sh{font-size:11px;color:#99a0b5;margin-top:1px}
        ._fc{padding:28px;border-radius:12px}
        ._fc h4{font-family:'Outfit',sans-serif;font-size:15px;font-weight:700;margin-bottom:18px}
        ...
        ._ft p{font-size:12px;color:#99a0b5}
        ._ft a{color:#eef0f6;text-decoration:none;font-weight:600;font-size:12.5px}
        ...
        ._ct h4{font-size:13px;font-weight:700}
        ._ct p{font-size:10px;color:#38d682}
        ...
        /* ── modal ── */
        ._mb{position:fixed;inset:0;background:rgba(0,0,0,.65);backdrop-filter:blur(8px);display:flex;align-items:center;justify-content:center;z-index:10000;opacity:0;pointer-events:none;transition:opacity .3s}
        ._mb.open{opacity:1;pointer-events:all}
        ._mc{background:#161920;border:1px solid #282f3e;border-radius:18px;padding:36px;width:95%;max-width:580px;position:relative;transform:translateY(20px);transition:transform .3s}
        ...
        ._mhl li{font-size:13px;color:#99a0b5;margin-bottom:5px}
        ._mlinks{display:flex;gap:14px}

        /* ── developer sidebar ── */
        ._dvcard{padding:22px}
        ._dvsec{padding-bottom:14px;margin-bottom:14px;border-bottom:1px solid #282f3e}
        ._dvlbl{font-size:10px;color:#666e82;font-weight:700;text-transform:uppercase;letter-spacing:.5px;margin-bottom:4px}
        ._dvval{font-family:'Outfit',sans-serif;font-size:22px;font-weight:800;color:#eef0f6}
        ._pb{height:4px;background:#282f3e;border-radius:3px;margin-top:3px}
        ._pf{height:100%;border-radius:3px}
        ._vbadge{display:flex;align-items:center;gap:6px;padding:7px 11px;background:rgba(255,255,255,.03);border-radius:6px;border:1px solid #282f3e;font-size:11px;color:#99a0b5;font-weight:600}
        ._vbadge .vc{color:#38d682;font-size:12px}
