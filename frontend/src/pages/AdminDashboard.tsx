...
export default function AdminDashboard({ userSession, handleLogout }: AdminDashboardProps) {
  ...
  return (
      ...
      {activeResultModal && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--surface-raised)', paddingBottom: '12px' }}>
              <h2 style={{ fontSize: '18px', fontWeight: '700', color: 'var(--text-primary)', margin: 0 }}>
                Add Semester Marks Record
              </h2>
              <button 
                type="button"
                onClick={() => { setActiveResultModal(null); setErrorMsg(''); }}
                style={{ background: 'none', border: 'none', fontSize: '20px', cursor: 'pointer', color: 'var(--text-secondary)' }}
              >
                ✕
              </button>
            ...
            <form onSubmit={activeResultModal === 'create' ? handleCreateResult : handleUpdateResult} style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                  <label style={{ fontSize: '12px', fontWeight: '600', color: 'var(--text-secondary)' }}>Student Roll No *</label>
                  <input 
                    type="text" 
                    required
                    className="form-input" 
    ...
    paddingLeft: '6px' }}
                    value={resRollNo}
                    onChange={(e) => setResRollNo(e.target.value.toUpperCase())}
                    placeholder="e.g. 22B01A0501"
                  />
                </div>

                <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                  <label style={{ fontSize: '12px', fontWeight: '600', color: 'var(--text-secondary)' }}>Semester No *</label>
                  <input 
                    type="number" 
                    required
                    min="1"
    ...
    paddingLeft: '6px' }}
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                <label style={{ fontSize: '12px', fontWeight: '600', color: 'var(--text-secondary)' }}>Exam Type / Name *</label>
                <input 
                  type="text" 
                  required
                  className="form-input" 
    ...
    paddingLeft: '6px'}}
                  value={resExamName}
                  onChange={(e) => setResExamName(e.target.value)}
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '120px 1fr', gap: '15px' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                  <label style={{ fontSize: '12px', fontWeight: '600', color: 'var(--text-secondary)' }}>Subject Code *</label>
                  <input 
                    type="text" 
                    required
                    className="form-input" 
                    style={{ background: 'var(--surface-base)', color: 'var(--text-primary)', border: '1px solid var(--card-border)',marginLeft: '1px',
    paddingLeft: '6px' }}
                    value={resSubjectCode}
                    onChange={(e) => setResSubjectCode(e.target.value.toUpperCase())}
                    placeholder="e.g. R22-CSE301"
                  />
                </div>

                <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                  <label style={{ fontSize: '12px', fontWeight: '600', color: 'var(--text-secondary)' }}>Subject Title</label>
                  <input 
                    type="text" 
                    required
                    className="form-input" 
    ...
    paddingLeft: '6px' }}
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '15px' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                  <label style={{ fontSize: '12px', fontWeight: '600', color: 'var(--text-secondary)' }}>Marks Score</label>
                  <input 
                    type="number" 
                    step="0.1"
                    required
    ...
    paddingLeft: '6px' }}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                  <label style={{ fontSize: '12px', fontWeight: '600', color: 'var(--text-secondary)' }}>Max Marks</label>
                  <input 
                    type="number" 
                    step="0.1"
                    required
    ...
    paddingLeft: '6px' }}
                    value={resMaxScore}
                    onChange={(e) => setResMaxScore(e.target.value)}
                    placeholder="e.g. 100.0"
                  />
                </div>

                <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                  <label style={{ fontSize: '12px', fontWeight: '600', color: 'var(--text-secondary)' }}>Grade Letter</label>
                  <input 
                    type="text" 
                    required
                    className="form-input" 
    ...
    paddingLeft: '6px' }}
              ...
              <div style={{ display: 'flex', gap: '15px', marginTop: '15px' }}>
                ...
                <button 
                  ...
                  style={{ flex: 1, padding: '12px', background: 'var(--accent)', borderColor: 'var(--accent)' }}
                >
                  {loading ? 'Processing...' : activeResultModal === 'create' ? 'Add Result' : 'Save Changes'}
                </button>
              </div>
            </form>
          </div>
